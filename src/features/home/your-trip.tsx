    ...
    <Card className="p-6">
      <div className="flex justify-between">
        <div className="space-y-3">
          <div className="font-semibold text-rose-600">Your Trip to Ha Noi</div>
          <h2 className="text-3xl font-semibold">Ready for your adventure!</h2>
          <p className="text-muted-foreground">
            Here`s a quick look at what you`ve go planned. Use your travel tools for a seamless
            experience in Korea
          </p>
          ...
          <div className="mt-3 space-y-3">
            <div className="flex gap-2">
              ...
              <div className="mt-2">
                ...
                <div className="text-muted-foreground text-sm">Today, 7:00 PM</div>
              </div>
            </div>
            <div className="flex gap-2">
              <div className="rounded-lg bg-white p-3">
              ...
              <div className="mt-2">
                ...
                <div className="text-muted-foreground text-sm">Today, 9:00 PM</div>
              </div>
            </div>
          </div>
        </div>
